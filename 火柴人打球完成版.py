...
class Flash():#实现动起来
    def __init__(self,pictures,x,y,w,h,xspeed,yspeed):
        ...
        self.no=0#造型编号
        self.qtime=0.01# 造型切换的时间 秒
        self.ytime=0.01#移动时间的间隔 秒
        self.x = x
        self.y =y
        self.w = w
        self.h =h
...
#        ballrect=pygame.draw.circle(screen,GREEN,(player.rect.center[0]+60,player.rect.center[1]+65),10)
...
def main():
    ...
    choosecharacters() 
    set_background2(pwlhead_x,pwlhead_y,pwrhead_x,pwrhead_y,prlhead_x,prlhead_y,prrhead_x,prrhead_y) #设置游戏界面背景
    #Play()
